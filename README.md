...
|---|---|---|
|  coordinates(shoot) |  KORDS + X + {x-coordinate} + Y + {y-coordinate} + #, {x-coordinate} and {y-coordinate} numbers from 1 until  10, e.g. KORDSX10Y2# | Water,  Ship_Hit, Ship_Destroyed, All_Ships_Destroyed, Game_Over|
